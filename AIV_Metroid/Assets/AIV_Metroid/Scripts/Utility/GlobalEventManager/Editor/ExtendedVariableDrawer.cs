...
public class ExtendedVariableDrawer : PropertyDrawer
{
    ...
    public override VisualElement CreatePropertyGUI(SerializedProperty property) {
        ...
        ExtendedVariableType variableType = (ExtendedVariableType)property.FindPropertyRelative("type").enumValueIndex;

        container.Add(namePropertyField);
        container.Add(variableTypeField);
        container.Add(GetCorrectElemen(container, variableType, property));
        variableTypeField.RegisterValueChangeCallback((evt) => {
            container.Add(GetCorrectElemen(
                container,
    ...
    private BindableElement GetCorrectElemen (VisualElement container, ExtendedVariableType type, SerializedProperty property) {
